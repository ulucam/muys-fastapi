    ...
    with engine.begin() as connection:
        ...
        migrationlar = {
            ...
            "urunler": [
                ...
                ("olcu", "ALTER TABLE urunler ADD COLUMN olcu VARCHAR(100) DEFAULT ''"),
                ("tahmini_uretim_suresi", "ALTER TABLE urunler ADD COLUMN tahmini_uretim_suresi FLOAT NOT NULL DEFAULT 0"),
